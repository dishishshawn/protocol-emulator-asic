# Roadmap — updated September 16, 2026
...
- **Instruction set:** DRIVE can already produce exact output durations; byte shifts, loops, input branches and bounded waits are now implemented; streaming and timestamped capture are implemented; repeated START and richer emulation remain.
