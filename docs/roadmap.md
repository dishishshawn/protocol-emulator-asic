...
| November 2026 | Stabilize memory/host interface; gate-level simulation of routed netlist; precheck; select optional FPGA target | Done early: fits 6×4 with clean DRC/LVS and timing. Remaining: SDF gate-level regression, precheck pass, FPGA evidence if available |
